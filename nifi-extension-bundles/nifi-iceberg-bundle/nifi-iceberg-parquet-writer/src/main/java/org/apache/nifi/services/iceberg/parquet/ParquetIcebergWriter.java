...
public class ParquetIcebergWriter extends AbstractControllerService implements IcebergWriter {
    ...
    static final PropertyDescriptor WRITE_TARGET_FILE_SIZE = new PropertyDescriptor.Builder()
            .name("Write Target File Size")
            .description("Controls the size of files generated to target about the number of configured bytes")
            .required(true)
            .defaultValue("512 MB")
    ...
    private long writeTargetFileSize;
    ...
    public void onEnabled(final ConfigurationContext context) {
        writeTargetFileSize = context.getProperty(WRITE_TARGET_FILE_SIZE).asDataSize(DataUnit.B).longValue();
    }

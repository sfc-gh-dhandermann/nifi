...
public class PutIcebergTable extends AbstractProcessor {
    ...
    private void writeRecords(final RecordReader recordReader, final IcebergRowWriter rowWriter, final AtomicLong recordsProcessed) throws IOException, MalformedRecordException {
        org.apache.nifi.serialization.record.Record inputRecord = recordReader.nextRecord();
        while (inputRecord != null) {
            final DelegatedRecord delegatedRecord = new DelegatedRecord(inputRecord);

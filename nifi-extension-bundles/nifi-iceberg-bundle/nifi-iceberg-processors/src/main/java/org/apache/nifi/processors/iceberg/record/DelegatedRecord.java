...
public class DelegatedRecord implements Record {
    ...
    public DelegatedRecord(final org.apache.nifi.serialization.record.Record record) {
        this.record = Objects.requireNonNull(record);
        final RecordSchema recordSchema = record.getSchema();
        this.struct = structTypeProvider.getStructType(recordSchema);
    }
    ...
    public Record copy(final Map<String, Object> overrides) {
        ...
        return new DelegatedRecord(mapRecord);
    }

...
class PutIcebergTableTest {
    ...
    private static final String NAMESPACE = PutIcebergTable.class.getSimpleName();
    ...
    void setRunner() throws InitializationException {
        runner = TestRunners.newTestRunner(PutIcebergTable.class);
    ...
    void testRunNoDataFiles() throws Exception {
        ...
        runner.assertAllFlowFilesTransferred(PutIcebergTable.SUCCESS);
    }
    ...
    void testRunWriteFailed() throws Exception {
        ...
        runner.assertAllFlowFilesTransferred(PutIcebergTable.FAILURE);
    }
    ...
    void testRunSuccess() throws Exception {
        ...
        final Long recordsProcessed = runner.getCounterValue(PutIcebergTable.RECORDS_PROCESSED_COUNTER);
        assertEquals(2, recordsProcessed);

        final Long dataFilesProcessed = runner.getCounterValue(PutIcebergTable.DATA_FILES_PROCESSED_COUNTER);
    ...
    private void setProperties() throws InitializationException {
        ...
        runner.setProperty(PutIcebergTable.ICEBERG_CATALOG, ICEBERG_CATALOG_ID);
        ...
        runner.setProperty(PutIcebergTable.ICEBERG_WRITER, ICEBERG_WRITER_ID);
        ...
        runner.setProperty(PutIcebergTable.RECORD_READER, RECORD_READER_ID);

        runner.setProperty(PutIcebergTable.NAMESPACE, NAMESPACE);
        runner.setProperty(PutIcebergTable.TABLE_NAME, TABLE_NAME);
    }
}

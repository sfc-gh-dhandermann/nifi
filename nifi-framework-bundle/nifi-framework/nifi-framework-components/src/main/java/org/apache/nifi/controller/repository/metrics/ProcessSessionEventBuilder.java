...
public class ProcessSessionEventBuilder {
    ...
    private static final ComponentMetricContext EMPTY_CONTEXT = new ComponentMetricContext("", "", "", Map.of());
    private static final ProcessSessionEvent EMPTY_EVENT = forComponent(EMPTY_CONTEXT).counters(Map.of()).build();
    ...
    /**
     * @param componentMetricContext the context of the component that the metrics belong to
     * @return a new builder for the given component
     */
    ...
    /**
     * @return a shared {@link ProcessSessionEvent} with an empty component context and zero metrics, suitable as a
     * placeholder when no metrics have been recorded for a component
     */
     ...
     *
     * @param event the event whose metrics should be added to this builder
     * @return this builder
     */
